...
/* harmony import */ var _modules_current_time__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/current-time */ "./js/modules/current-time.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_current_time__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__["iosVhFix"])();
  Object(_modules_mobile_menu__WEBPACK_IMPORTED_MODULE_2__["default"])();
});

/***/ }),

/***/ "./js/modules/current-time.js":
/*!************************************!*\
  !*** ./js/modules/current-time.js ***!
  \************************************/
...
function showCurrentTime() {
  ...
  function updateClock() {
    var time = new Date();
    clock.textContent = "\u0422\u0435\u043A\u0443\u0449\u0435\u0435 \u0432\u0440\u0435\u043C\u044F: ".concat(time.toLocaleTimeString('ru-RU', {
      hour12: false
    }));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (showCurrentTime);
...
function initMobileMenu() {
  ...
  var btnOpen = document.querySelector('.mobile-menu--burger');
  var btnClose = document.querySelector('.mobile-menu--close');
  ...
  if (btnOpen && mainNav) {
    btnOpen.addEventListener('click', function () {
      if (!mainNav.classList.contains('main-nav--is-open') || mainNav.classList.contains('main-nav--is-closed')) {
        ...
        body.classList.add('.scroll-lock', 'scroll-lock-ios'); // scrollLock.disableScrolling();
      }
    });
  }
  ...
  if (btnClose) {
    btnClose.addEventListener('click', function () {
      if (mainNav.classList.contains('main-nav--is-open')) {
        mainNav.classList.remove('main-nav--is-open');
        mainNav.classList.add('main-nav--is-closed');
        body.classList.remove('.scroll-lock', 'scroll-lock-ios'); // scrollLock.enableScrolling();
      }
    });
  }
}
